...
export function SiteFooter() {
  return (
    <footer className="bg-[#0a1628] py-20 text-[#8b95a1]">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-8">
            <div className="space-y-4">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[13px]">
                ...
                <span>대표이사 문원오</span>
                <span className="hidden lg:inline text-[#2f3338]">|</span>
              ...
              <div className="mt-6 space-y-2 text-[12px] leading-relaxed text-[#4e5968]">
                <p>
            ...
            <div className="text-right flex flex-col gap-1 shrink-0">
              <p className="text-[14px] font-bold text-white">
                사업제휴 문의: <span className="text-[#3182f6] font-medium ml-1 text-[15px]">doogobiz@gmail.com</span>
              </p>
              <p className="text-[12px] opacity-60">
                점심시간 1시-2시 제외 · 주말/공휴일 제외 · 평일 오전 10시~오후 6시
              </p>
            </div>
          </div>
        </div>
